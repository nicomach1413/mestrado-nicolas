...
function main()
    ...
    println(U)
    println("Esforços axiais")
    println(N)
    println("Esforços cisalhantes em Y - Sistema local do elemento")
    println(Vy)
    println("Momentos fletores no eixo Y - Sistema local do elemento")
    println(My)
    println("Esforços cisalhantes em Z - Sistema local do elemento")
    println(Vz)
    println("Momentos fletores no eixo Z - Sistema local do elemento")
    println(Mz)
    println("Esforços de torção")
    println(Tor)
